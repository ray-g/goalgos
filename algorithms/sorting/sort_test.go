...
func (ns IntSlice) Get(i int) interface{}       { return ns[i] }
func (ns IntSlice) Change(i int, v interface{}) { ns[i] = v.(int) }
...
func testCSort(t *testing.T, name string, foo func(s Changeable)) {
	tcs := makeTestCases()
...
func TestHeapSort(t *testing.T)   { testCSort(t, "HeapSort", HeapSort) }
