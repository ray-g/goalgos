...
func benchmarkCSort(b *testing.B, foo func(s Changeable), size int) {
	s := makeIntSlice(size)
...
func BenchmarkHeapSort1000(b *testing.B)   { benchmarkCSort(b, HeapSort, 1000) }
func BenchmarkHeapSort10000(b *testing.B)  { benchmarkCSort(b, HeapSort, 10000) }
func BenchmarkHeapSort100000(b *testing.B) { benchmarkCSort(b, HeapSort, 100000) }
